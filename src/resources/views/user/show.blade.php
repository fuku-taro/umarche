          ...
          <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
              <div class="p-6 text-gray-900">
                  ...
                  <div class="mb-4 text-center">
                    ...
                    @else
                      <img class="mx-auto w-40 h-40 rounded-full object-cover" src="{{ asset('images/no_image.jpg') }}">
                    @endif
                  </div>
                  <div class="mb-4 text-center">
                    <button data-micromodal-trigger="modal-1" href='javascript:;' type="button" class="bg-green-400 border-0 py-2 px-6 focus:outline-none hover:bg-green-500 rounded">
                      ショップの詳細を見る
                    </button>
                  </div>
              </div>
